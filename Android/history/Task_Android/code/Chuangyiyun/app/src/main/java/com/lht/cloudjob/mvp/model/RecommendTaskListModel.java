 ...
 * <p><b>Classname</b> RecommendTaskListModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/8/24
 * <p>
 * to see API at{@link IRestfulApi.RecommendTaskListApi}
 * to see ResBean at{@link RecommendTaskResBean}
 */
public class RecommendTaskListModel implements IPagedApiRequestModel {
    private final ApiModelCallback<ArrayList<RecommendTaskResBean>> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.RecommendTaskListApi api;
    ...
    public RecommendTaskListModel(ApiModelCallback<ArrayList<RecommendTaskResBean>> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.RecommendTaskListApi();
    }
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (bean.isSuccess()) {
                    ArrayList<RecommendTaskResBean> data =
                            (ArrayList<RecommendTaskResBean>) JSON.parseArray(bean.getData(),
                                    RecommendTaskResBean.class);
