 ...
 * <p><b>Classname</b> MessageListModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/8/19
 * <p>
 * to see API at{@link IRestfulApi.MessageListApi}
 * to see ResBean at{@link MessageListItemResBean}
 */
public class MessageListModel implements IApiRequestModel {

    private final ApiModelCallback<ArrayList<MessageListItemResBean>> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.MessageListApi api;
    ...
    public MessageListModel(String user, int offset, IRestfulApi.MessageListApi.MessageType type,
                            ApiModelCallback<ArrayList<MessageListItemResBean>> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.MessageListApi();
        params = api.newRequestParams(user, offset, type);
    }
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (bean.isSuccess()) {
                    ArrayList<MessageListItemResBean> data = (ArrayList<MessageListItemResBean>)
                            JSON.parseArray(bean.getData(),
                                    MessageListItemResBean.class);
