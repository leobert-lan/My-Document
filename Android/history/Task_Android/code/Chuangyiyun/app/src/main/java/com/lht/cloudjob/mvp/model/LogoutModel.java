 ...
 * <p><b>Classname</b> LogoutModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/9/7
 */
public class LogoutModel implements IApiRequestModel {
    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.LogoutApi api;
    ...
    public LogoutModel(String uid, String sess, String token, ApiModelCallback<BaseVsoApiResBean>
            modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.LogoutApi();
        params = api.newRequestParams(uid, sess, token);
    }
