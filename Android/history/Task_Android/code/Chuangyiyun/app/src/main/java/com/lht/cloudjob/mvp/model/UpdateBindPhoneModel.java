 ...
 * to see API at{@link IRestfulApi.UpdateBindPhoneApi}
...
public class UpdateBindPhoneModel implements IApiRequestModel {
    ...
    private IRestfulApi.UpdateBindPhoneApi api;
    private RequestParams params;
    private RequestHandle handle;

    public UpdateBindPhoneModel(String username, String phone, ApiModelCallback<BaseVsoApiResBean>
            modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.UpdateBindPhoneApi();
        params = api.newRequestParams(username, phone);
