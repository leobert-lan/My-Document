 ...
 * <p><b>Classname</b> ResetPwdByUsernameModel
 * <p><b>Description</b>: TODO
 * Created by leobert on 2016/7/15.
 * <p>
 * to see API at{@link IRestfulApi.ResetPwdByUsernameApi}
 * to see ResBean at{@link BaseVsoApiResBean}
 */
public class ResetPwdByUsernameModel implements IApiRequestModel {

    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.ResetPwdByUsernameApi api;

    private RequestParams params;
    private RequestHandle handle;

    public ResetPwdByUsernameModel(String username, String password, ApiModelCallback<BaseVsoApiResBean> callback) {
        this.modelCallback = callback;
        this.mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.ResetPwdByUsernameApi();
        params = api.newRequestParams(username, password);
    }
