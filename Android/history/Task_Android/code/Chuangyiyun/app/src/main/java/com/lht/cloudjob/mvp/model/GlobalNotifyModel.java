 ...
 * <p><b>Classname</b> GlobalNotifyModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/9/7
 */
public class GlobalNotifyModel implements IApiRequestModel {
    private final ApiModelCallback<ArrayList<GlobalNotifyResBean>> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.GlobalNotifyApi api;
    ...
    public GlobalNotifyModel(ApiModelCallback<ArrayList<GlobalNotifyResBean>> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.GlobalNotifyApi();
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (bean.isSuccess()) {
                    ArrayList<GlobalNotifyResBean> data =
                            (ArrayList<GlobalNotifyResBean>) JSON.parseArray(bean.getData(),
                                    GlobalNotifyResBean.class);
