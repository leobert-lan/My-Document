 ...
 * <p><b>Classname</b> DiscollectTaskModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/8/25
 * <p>
 * to see API at {@link IRestfulApi.DiscollectTaskApi}
 * to see ResBean at{@link BaseVsoApiResBean}
 */
public class DiscollectTaskModel implements IApiRequestModel {

    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.DiscollectTaskApi api;
    ...
    public DiscollectTaskModel(String user, ArrayList<String> tasks,
                               ApiModelCallback<BaseVsoApiResBean> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.DiscollectTaskApi();
        params = api.newRequestParams(user, tasks);
    }

    public DiscollectTaskModel(String user, String taskId,
                               ApiModelCallback<BaseVsoApiResBean> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.DiscollectTaskApi();
