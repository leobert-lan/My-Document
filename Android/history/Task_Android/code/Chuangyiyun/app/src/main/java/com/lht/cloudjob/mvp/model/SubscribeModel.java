 ...
 * <p><b>Classname</b> SubscribeModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/9/19
 */
public class SubscribeModel implements IApiRequestModel {
    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.SubscribeApi api;
    ...
    public SubscribeModel(String username, ArrayList<Integer> ids,
                          ApiModelCallback<BaseVsoApiResBean> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.SubscribeApi();
        params = api.newRequestParams(username, trans(ids));
    }

    private String trans(ArrayList<Integer> ids) {
