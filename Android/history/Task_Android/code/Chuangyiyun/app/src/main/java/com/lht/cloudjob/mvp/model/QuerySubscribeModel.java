 ...
 * <p><b>Classname</b> QuerySubscribeModel
 * <p><b>Description</b>: 查询订阅内容model
 * <p> Create by Leobert on 2016/9/19
 */
public class QuerySubscribeModel implements IApiRequestModel {
    private final ApiModelCallback<QuerySubscribeResBean> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.QuerySubscribeApi api;
    ...
    public QuerySubscribeModel(String username, ApiModelCallback<QuerySubscribeResBean> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.QuerySubscribeApi();
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (bean.isSuccess()) {
                    QuerySubscribeResBean data = JSON.parseObject(bean.getData(),
                            QuerySubscribeResBean.class);
