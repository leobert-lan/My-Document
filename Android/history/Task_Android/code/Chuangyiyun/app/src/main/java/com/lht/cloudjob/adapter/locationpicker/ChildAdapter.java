package com.lht.cloudjob.adapter.locationpicker;
...
public class ChildAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<ChildEntity> mChildren;// 数据源

    public ChildAdapter(Context context, ArrayList<ChildEntity> chileren) {
