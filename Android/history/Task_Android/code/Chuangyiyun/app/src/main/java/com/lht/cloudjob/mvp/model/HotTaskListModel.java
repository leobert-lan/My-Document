 ...
 * <p><b>Classname</b> HotTaskListModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/8/19
 * <p>
 * to see API at {@link IRestfulApi.HotTaskListApi}
 * to see ResBean at {@link HotTaskResBean}
 */
public class HotTaskListModel implements IApiRequestModel {

    private final ApiModelCallback<ArrayList<HotTaskResBean>> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.HotTaskListApi api;
    ...
    public HotTaskListModel(ApiModelCallback<ArrayList<HotTaskResBean>> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.HotTaskListApi();
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (bean.isSuccess()) {
                    ArrayList<HotTaskResBean> data =
                            (ArrayList<HotTaskResBean>) JSON.parseArray(bean.getData(),
                                    HotTaskResBean.class);
