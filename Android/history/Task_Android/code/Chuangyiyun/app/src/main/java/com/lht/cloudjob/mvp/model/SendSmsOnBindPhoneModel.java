 ...
 */
public class SendSmsOnBindPhoneModel implements IApiRequestModel {
    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.SendSmsOnBindPhoneApi api;
    ...
    public SendSmsOnBindPhoneModel(String target, String user,
                                   ApiModelCallback<BaseVsoApiResBean> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.SendSmsOnBindPhoneApi();
        params = api.newRequestParams(target, user);
    }
