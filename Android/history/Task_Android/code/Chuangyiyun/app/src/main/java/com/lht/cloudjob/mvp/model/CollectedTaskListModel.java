 ...
 * <p><b>Classname</b> CollectedTaskListModel
 * <p><b>Description</b>: 收藏的(需求)列表model
 * <p> Create by Leobert on 2016/8/23
 *
 * to see ResBean at{@link CollectedTaskResBean}
 * to see API at{@link IRestfulApi.CollectedTaskListApi}
 */
public class CollectedTaskListModel implements IPagedApiRequestModel {

    private final ApiModelCallback<ArrayList<CollectedTaskResBean>> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.CollectedTaskListApi api;
    ...
    public CollectedTaskListModel(ApiModelCallback<ArrayList<CollectedTaskResBean>> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.CollectedTaskListApi();
    }
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (bean.isSuccess()) {
                    ArrayList<CollectedTaskResBean> data =
                            (ArrayList<CollectedTaskResBean>) JSON.parseArray(bean.getData(),
                                    CollectedTaskResBean.class);
