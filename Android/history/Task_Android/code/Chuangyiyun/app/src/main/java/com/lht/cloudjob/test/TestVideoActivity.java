...
public class TestVideoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String testMedia1 =
            "https://cbs.vsochina.com/storage/users/zhou88/download?path=/Leo/fade.mp4&access_id=1&access_token=1";
    private static final String testMedia2 =
            "https://cbs.vsochina.com/storage/users/zhou88/download?path=/Leo/fade.mp4&access_id=1&access_token=1";
