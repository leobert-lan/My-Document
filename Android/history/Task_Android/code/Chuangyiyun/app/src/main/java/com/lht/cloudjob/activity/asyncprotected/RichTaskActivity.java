...
import com.lht.cloudjob.mvp.presenter.RichTaskPresenter;
...
public class RichTaskActivity extends AsyncProtectedActivity implements IRichTaskActivity,
    ...
    private RichTaskPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rich_task);
        initView();
        initVariable();
        initEvent();
    }
    ...
    protected String getPageName() {
        return RichTaskActivity.PAGENAME;
    }

    @Override
    public UMengActivity getActivity() {
        return RichTaskActivity.this;
    }
    ...
    protected void initView() {
        ...
        pullToRefreshListView = (PullToRefreshListView) findViewById(R.id.richtask_list_tasks);
    ...
    protected void initVariable() {
        presenter = new RichTaskPresenter(this);
    ...
    protected void initEvent() {
        ...
        titleBar.setTitle(R.string.title_activity_richtask);
