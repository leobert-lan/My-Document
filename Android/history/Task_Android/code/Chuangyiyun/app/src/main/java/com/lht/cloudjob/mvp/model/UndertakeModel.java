 ...
 * <p><b>Classname</b> UndertakeModel
 * <p><b>Description</b>: TODO
 * <p>Created by Administrator on 2016/9/2.
 *
 * to see API at{@link IRestfulApi.UndertakeApi}
 * to see ResBean at{@link BaseVsoApiResBean}
 */

public class UndertakeModel implements IApiRequestModel {
    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;
    private final HttpUtil mHttpUtil;

    private IRestfulApi.UndertakeApi api;

    private RequestParams params;

    private RequestHandle handle;

    public UndertakeModel(LetterBean letterBean, ApiModelCallback<BaseVsoApiResBean> callback) {
        this.modelCallback = callback;
        this.mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.UndertakeApi();
        params = api.newRequestParams(letterBean);
    }
