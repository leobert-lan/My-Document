 ...
 * <p><b>Classname</b> DeleteMsgModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/8/29
 * <p>
 * to see API at{@link IRestfulApi.DeleteMsgApi}
 * to see ResBean at{@link BaseVsoApiResBean}
 */
public class DeleteMsgModel implements IApiRequestModel {

    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.DeleteMsgApi api;
    ...
    public DeleteMsgModel(ArrayList<String> ids, ApiModelCallback<BaseVsoApiResBean>
            modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.DeleteMsgApi();
