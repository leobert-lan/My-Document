 ...
 * <p><b>Classname</b> UndertakeCheckPermissionModel
 * <p><b>Description</b>: TODO
 * <p>Created by Administrator on 2016/9/13.
 */

public class UndertakeCheckPermissionModel implements IApiRequestModel {
    private final ApiModelCallback<BaseVsoApiResBean> modelCallback;
    private final HttpUtil mHttpUtil;

    private IRestfulApi.UndertakeCheckPermission api;

    private RequestParams params;

    private RequestHandle handle;

    public UndertakeCheckPermissionModel(String username, ApiModelCallback<BaseVsoApiResBean> callback) {
        this.modelCallback = callback;
        this.mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.UndertakeCheckPermission();
