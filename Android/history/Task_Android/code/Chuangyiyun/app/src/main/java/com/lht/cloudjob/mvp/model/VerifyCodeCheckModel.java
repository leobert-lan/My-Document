 ...
 * <p>
 * to see API at{@link IRestfulApi.CheckVerifyCodeApi}
...
public class VerifyCodeCheckModel implements IApiRequestModel {
    ...
    private IRestfulApi.CheckVerifyCodeApi api;

    private RequestHandle handle;

    public VerifyCodeCheckModel(String phone, String code, ApiModelCallback<BaseVsoApiResBean> callback) {
        modelCallback = callback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.CheckVerifyCodeApi();
        params = api.newRequestParams(phone, code);
    }
