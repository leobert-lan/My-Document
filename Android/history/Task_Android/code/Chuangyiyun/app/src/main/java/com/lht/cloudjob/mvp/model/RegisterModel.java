...
public class RegisterModel implements IApiRequestModel {
    ...
    private IRestfulApi.RegisterApi api;
    ...
    public RegisterModel(String phone, String pwd, ApiModelCallback<RegisterResBean> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.RegisterApi();
        params = api.newRequestParams(phone, pwd);
    }
