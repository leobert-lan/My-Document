 ...
 * <p><b>Classname</b> RichTaskListModel
 * <p><b>Description</b>: TODO
 * <p> Create by Leobert on 2016/8/22
 * <p>
 * to see API at{@link IRestfulApi.RichTaskListApi}
 * to see ResBean at{@link RichTaskResBean}
 */
public class RichTaskListModel implements IApiRequestModel {

    private final ApiModelCallback<ArrayList<RichTaskResBean>> modelCallback;

    private final HttpUtil mHttpUtil;

    private IRestfulApi.RichTaskListApi api;
    ...
    public RichTaskListModel(ApiModelCallback<ArrayList<RichTaskResBean>> modelCallback) {
        this.modelCallback = modelCallback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.RichTaskListApi();
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (bean.isSuccess()) {
                    ArrayList<RichTaskResBean> data =
                            (ArrayList<RichTaskResBean>) JSON.parseArray(bean.getData(),
                                    RichTaskResBean.class);
