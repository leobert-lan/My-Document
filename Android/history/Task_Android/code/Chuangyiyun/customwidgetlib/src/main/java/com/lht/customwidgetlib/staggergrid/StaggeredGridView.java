...
import com.lht.customwidgetlib.staggergrid.listener.OnLoadingListener;
 ...
 * <p/>
 * 一些属性：
 * <li>column_count" format="integer"
 * <li>column_count_portrait" format="integer"
 * <li>column_count_landscape" format="integer"
 * <li>item_margin" format="dimension"
 * <li>grid_paddingLeft" format="dimension"
 * <li>grid_paddingRight" format="dimension"
 * <li>grid_paddingTop" format="dimension"
 * <li>grid_paddingBottom" format="dimension"
 */
public class StaggeredGridView extends ExtendableListView {
    ...
    public StaggeredGridView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        if (attrs != null) {
            ...
            typedArray.recycle();
            //TODO
            Log.d("lmsg", "set inner scrolListener");
            super.setOnScrollListener(innerOnScrollListener);
        }
    ...
    @Deprecated
    /**
     * desc: 为了提供自动加载功能，使用addOnScrollListener来监听
     */
    ...
    public void postLoadingFinish() {
        mRequestedMore = false;
    }
    ...
    private OnScrollListener innerOnScrollListener = new OnScrollListener() {
        ...
        public void onScrollStateChanged(AbsListView view, int scrollState) {
            ...
            if (wrapperOnScrollListener != null)
                wrapperOnScrollListener.onScrollStateChanged(view, scrollState);
        }
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            if (!mRequestedMore) {
                ...
                if (lastInScreen >= totalItemCount) {
                    Log.d("lmsg", "onScroll lastInScreen - so load more");
                    mRequestedMore = true;
            ...
            if (wrapperOnScrollListener != null)
                wrapperOnScrollListener.onScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
        }
    };

    private OnScrollListener wrapperOnScrollListener = null;

    public void addOnScrollListener(OnScrollListener l) {
        this.wrapperOnScrollListener = l;
    }
