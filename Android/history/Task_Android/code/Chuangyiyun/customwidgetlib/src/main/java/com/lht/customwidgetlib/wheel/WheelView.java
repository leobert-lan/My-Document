package com.lht.customwidgetlib.wheel;
...
import com.lht.customwidgetlib.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.h6_divider));
		// 设置线宽
