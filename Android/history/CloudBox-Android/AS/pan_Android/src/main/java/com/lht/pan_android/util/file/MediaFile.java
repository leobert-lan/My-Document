...
public class MediaFile {
	...
	/**
	 * @Title: isVideoFileType
	 * @Description: 根据音频文件路径找到文件格式
	 * @author: zhangbin
	 * @param path
	 * @return
	 */
	...
	/**
	 * @Title: isImageFileType
	 * @Description: 根据图片文件路径找到文件格式
	 * @author: zhangbin
	 * @param path
	 * @return
	 */
	...
	public boolean isPlayFileType(String path) { // 自己增加
		MediaFileType type = getFileType(path);
		if (null != type) {
	...
	/**
	 * @Title: getFileTypeForMimeType
	 * @Description: 根据mime类型查看文件类型
	 * @author: zhangbin
	 * @param mimeType
	 * @return
	 */
