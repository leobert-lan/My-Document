...
public class DragLayout extends FrameLayout {
	...
	public void addDragImageListener(View v, OnDragChildClickListener dragChildClickListener) {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			Log.d("lmsg", "intercept");
			float x = ev.getX();
			float y = ev.getY();
			Rect frame = new Rect();
			view = getHitView(x, y);
			if (view == null) {
				Log.d("lmsg", "inter null");
				return false;
			}
			dragInit(view);
			// TODO 判断略显冗余
