...
// // Log.i(DEBUG_TAG, "mScrollPosition = " + position + " offset = " +
// // String.format("%f.2", positionOffset));
...
// }
//
// final boolean isFirstOrLast = mScrollPosition == 0
// || (mScrollPosition == (getAdapter().getCount() - 1));
...
// // Log.i(DEBUG_TAG, visibleRect.left+ ", " +
// // mScrollPositionOffsetPixels + ", degress = "+
