...
public class HybridMyAttentionActivity extends AbsHybridActivityBase {
    private static final String PAGENAME = "HybridMyAttentionActivity";
    ...
    protected String getPageName() {
        return HybridMyAttentionActivity.PAGENAME;
    }

    @Override
    public BaseActivity getActivity() {
        return HybridMyAttentionActivity.this;
    }

    @Override
    protected int getContentLayoutRes() {
        return R.layout.activity_hybrid_my_attention;
    }
    ...
    protected void initEvent() {
        ...
        titleBar.setTitle(getString(R.string.v1000_default_homepage_text_my_attention));
    ...
    protected String getUrl() {
        return new IHybridPagesCollection.HybridMyAttention().getPageUrl();
    }
    ...
    public static final class Launcher extends AbsActivityLauncher<Void> {
        ...
        protected LhtActivityLauncherIntent newBaseIntent(Context context) {
            return new LhtActivityLauncherIntent(context, HybridMyAttentionActivity.class);
        }
