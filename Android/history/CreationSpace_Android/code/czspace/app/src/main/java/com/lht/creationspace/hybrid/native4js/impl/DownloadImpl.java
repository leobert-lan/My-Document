...
import com.lht.creationspace.hybrid.native4js.expandresbean.NF_DownloadResBean;
...
public class DownloadImpl extends ABSApiImpl<NF_DownloadReqBean> implements Native4JsExpandAPI.DownloadHandler {
...
//    public
    ...
    @Override
    protected boolean isBeanError(NF_DownloadReqBean bean) {
