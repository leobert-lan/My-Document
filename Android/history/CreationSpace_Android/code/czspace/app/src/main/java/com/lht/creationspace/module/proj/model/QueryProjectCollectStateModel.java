 ...
 * 查询用户是否收藏项目model
 */
public class QueryProjectCollectStateModel extends AbsRestfulApiModel
        implements IApiRequestModel {
    private RestfulApiModelCallback<ModelResBean> callback;
    private HttpUtil mHttpUtil;
    private IRestfulApi.QueryProjectCollectStateApi api;
    private RequestParams params;
    private RequestHandle handle;

    public QueryProjectCollectStateModel(QueryProjectCollectStateData data,
                                         RestfulApiModelCallback<ModelResBean> callback) {
        this.callback = callback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.QueryProjectCollectStateApi();
    ...
    public static class QueryProjectCollectStateData{
        private String user;
