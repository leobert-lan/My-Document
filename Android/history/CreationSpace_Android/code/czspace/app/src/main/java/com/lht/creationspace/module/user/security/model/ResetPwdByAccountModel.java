 ...
 * <p>
 * to see API at{@link IApiNewCollections.ResetPwdByAccountApi}
...
public class ResetPwdByAccountModel implements IApiRequestModel {
    ...
    private IApiNewCollections.ResetPwdByAccountApi api;

    private RequestParams params;

    private RequestHandle handle;

    public ResetPwdByAccountModel(ModelRequestData data,ApiModelCallback<BaseVsoApiResBean> callback) {
        this.modelCallback = callback;
        this.mHttpUtil = HttpUtil.getInstance();
        api = new IApiNewCollections.ResetPwdByAccountApi();
