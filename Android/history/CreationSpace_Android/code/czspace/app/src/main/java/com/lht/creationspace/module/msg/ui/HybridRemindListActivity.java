...
public class HybridRemindListActivity extends HybridGeneralActivity {
    ...
    protected String getUrl() {
        return new IHybridPagesCollection.HybridRemindList()
    ...
    protected String getPageName() {
        return HybridRemindListActivity.PAGENAME;
    }

    @Override
    public BaseActivity getActivity() {
        return HybridRemindListActivity.this;
    }
    ...
    public static final class Launcher extends AbsActivityLauncher<Void> {
        ...
        protected LhtActivityLauncherIntent newBaseIntent(Context context) {
            return new LhtActivityLauncherIntent(context, HybridRemindListActivity.class);
        }
