 ...
 * 首页-推荐
 */
public class FgHomeIndexRecommend extends AbsHybridFragmentBase {
    private PtrBridgeWebView ptrBridgeWebView;

    private static final String PAGE_NAME = FgHomeIndexRecommend.class.getSimpleName();

    private MaskView maskView;

    public FgHomeIndexRecommend() {
