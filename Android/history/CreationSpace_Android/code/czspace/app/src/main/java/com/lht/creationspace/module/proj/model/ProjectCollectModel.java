 ...
 * 用户收藏项目
 */
public class ProjectCollectModel extends AbsRestfulApiModel
        implements IApiRequestModel {
    private RestfulApiModelCallback<String> callback;
    private HttpUtil mHttpUtil;
    private IRestfulApi.CollectProjectApi api;
    private RequestParams params;
    private RequestHandle handle;

    public ProjectCollectModel(ProjectCollectData data,
                               RestfulApiModelCallback<String> callback) {
        this.callback = callback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.CollectProjectApi();
    ...
    public static class ProjectCollectData {
        private String user;
