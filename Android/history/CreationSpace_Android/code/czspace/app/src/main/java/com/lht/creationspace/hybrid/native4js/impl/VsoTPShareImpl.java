...
import com.lht.creationspace.customview.share.ThirdPartyShareHandler;
...
public class VsoTPShareImpl extends ABSApiImpl<NF_TPShareReqBean> implements Native4JsExpandAPI.TPShareHandler {
...
//    public
    ...
    private void callShare(IPopupHolder iPopupHolder, NF_TPShareReqBean reqBean,
        ...
        ThirdPartySharePopWins.UrlShareData shareData = new ThirdPartySharePopWins.UrlShareData();
        shareData.setOpenUrl(reqBean.getUrl());
        shareData.setShareTitle(reqBean.getTitle());
        shareData.setShareSummary(reqBean.getSummary());
    ...
    private class ShareCloumnItemClickListener extends ThirdPartyShareHandler {
...
//    public
    ...
    @Override
    protected boolean isBeanError(NF_TPShareReqBean bean) {
        //ignore
//        NF_TPShareReqBean bean = (NF_TPShareReqBean) o;
