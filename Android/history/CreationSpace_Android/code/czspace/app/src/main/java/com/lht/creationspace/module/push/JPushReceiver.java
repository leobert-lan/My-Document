...
import com.lht.creationspace.base.activity.asyncprotected.BannerInfoActivity;
...
import com.lht.creationspace.umeng.customerror.PushAccessError;
import com.lht.creationspace.umeng.customerror.PushContentError;
            ...
            if (messageExtra != null) {
                ...
                switch (objType) {
                    ...
                    case JpushMessage.MessageExtra.OBJ_TYPE_VSONOTIFY:
                        ...
                        break;
                    default:
                        Log.e(TAG, "jpush 收到的 message,extra业务有误:obj_type=" + objType);
                        PushContentError error = new PushContentError(getSerializedBundle(bundle));
                        error.report(context);
                        break;
                }
    ...
    private void processActivityTypeMessage(Context context, JpushMessage.AndroidMessage message) {
        ...
        synchronized (this) {
            if (shouldRestrict) {
                ...
                openIntent.putExtra(UMengActivity.KEY_ORIGINCLASS_SHOULDREDIRECTONFINISH,s);
            } else {
