 ...
 * 首页-关注
 */
public class FgHomeIndexFavor extends AbsHybridFragmentBase {
    private PtrBridgeWebView ptrBridgeWebView;

    private static final String PAGE_NAME = FgHomeIndexFavor.class.getSimpleName();

//    private HomeTitleBar1 titleBar;
    private MaskView maskView;

    public FgHomeIndexFavor() {
    ...
    protected String getUrl() {
        return new IHybridPagesCollection.HybridHomeIndexFavor().getPageUrl();
    }
