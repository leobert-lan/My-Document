...
public class ProjectTypeModel extends AbsRestfulApiModel implements IApiRequestModel {
    private RestfulApiModelCallback<ArrayList<ProjectTypeResBean>> callback;

    private HttpUtil mHttpUtil;

    IRestfulApi.ProjectTypeListApi api;

    RequestParams params;

    private RequestHandle handle;

    public ProjectTypeModel(RestfulApiModelCallback<ArrayList<ProjectTypeResBean>> callback) {
        this.callback = callback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.ProjectTypeListApi();
    ...
    public void doRequest(Context context) {
        ...
        composite.addHandler(new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                ArrayList<ProjectTypeResBean> data = (ArrayList<ProjectTypeResBean>) JSON.parseArray(res, ProjectTypeResBean.class);
