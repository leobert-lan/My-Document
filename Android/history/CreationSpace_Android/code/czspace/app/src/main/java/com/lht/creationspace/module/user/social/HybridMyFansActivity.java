...
public class HybridMyFansActivity extends AbsHybridActivityBase {
    private static final String PAGENAME = "HybridMyFansActivity";
    ...
    protected String getPageName() {
        return HybridMyFansActivity.PAGENAME;
    }

    @Override
    public BaseActivity getActivity() {
        return HybridMyFansActivity.this;
    }

    @Override
    protected int getContentLayoutRes() {
        return R.layout.activity_hybrid_my_fans;
    }
    ...
    protected void initEvent() {
        ...
        titleBar.setTitle(getString(R.string.v1000_default_homepage_text_my_fans));
    ...
    protected String getUrl() {
        return new IHybridPagesCollection.HybridMyFans().getPageUrl();
    }
    ...
    public static final class Launcher extends AbsActivityLauncher<Void> {
        ...
        protected LhtActivityLauncherIntent newBaseIntent(Context context) {
            return new LhtActivityLauncherIntent(context, HybridMyFansActivity.class);
        }
