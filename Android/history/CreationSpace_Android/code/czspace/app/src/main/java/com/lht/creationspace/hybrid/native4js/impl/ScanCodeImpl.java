package com.lht.creationspace.hybrid.native4js.impl;//package com.lht.vsocyy.native4js.impl;
//
...
//import com.lht.vsocyy.native4js.Native4JsExtendAPI;
...
// * @version 1.0
// */
//public class ScanCodeImpl extends ABSLTRApiImpl implements Native4JsExtendAPI.ScanCodeHandler {
//
...
//					response(NativeRet.NativeScanCodeRet.RET_UNSUPPORT, "unsupported encoding type", data);
//					break;
//				case ScanActivity.SCAN_TIMEOUT:
//					response(NativeRet.NativeScanCodeRet.RET_TIMEOUT, "scan time out", data);
//					break;
...
//			bean.setMsg(msg);
//			bean.setRet(ret);
//			executor.getHandler().onJobExecuted(JSON.toJSONString(bean));
//		}
//	};
//}
