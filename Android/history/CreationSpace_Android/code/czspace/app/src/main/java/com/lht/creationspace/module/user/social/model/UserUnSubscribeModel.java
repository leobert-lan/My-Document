 ...
 * 用户关注model
 */
public class UserUnSubscribeModel extends AbsRestfulApiModel implements IApiRequestModel {
    private RestfulApiModelCallback<String> callback;
    private HttpUtil mHttpUtil;
    private IRestfulApi.UnSubscribeUserApi api;
    private RequestParams params;
    private RequestHandle handle;

    public UserUnSubscribeModel(String operateId,
                                RestfulApiModelCallback<String> callback) {
        this.callback = callback;
        mHttpUtil = HttpUtil.getInstance();
        api = new IRestfulApi.UnSubscribeUserApi();
